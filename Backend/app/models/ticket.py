...
class Ticket(Base):
    ...
    alert_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), ForeignKey("alert_records.id", ondelete="SET NULL"), nullable=True)
    ...
    alert = relationship("AlertRecord", back_populates="ticket")
